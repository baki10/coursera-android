...
public class DownloaderTaskFragment extends Fragment {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    ArrayList<Integer> integers = getArguments().getIntegerArrayList(MainActivity.TAG_FRIEND_RES_IDS);


    // TODO: Start the DownloaderTask
    assert integers != null;
    downloaderTask.execute(integers.toArray(new Integer[integers.size()]));
  ...
  public class DownloaderTask extends AsyncTask<Integer, Void, String[]> {
    ...
    protected void onPostExecute(String[] strings) {
      if (mCallback != null)
        mCallback.notifyDataDownloadFinished(strings);
    }
  }
